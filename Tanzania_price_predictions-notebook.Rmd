...
# Comparing Pooled Vs Crop Specific Price Predictions 
We are comparing Crop Specific Price Predictions to determine which model performs better at prediction by comparing predictions r2 or rmse

## Function to evaluate models for a specific crop
```{r}
evaluate_models <- function(crop) {
  ...
  pooled_pred_crop <- predict(object=rf, newdata = validation_data_crop)
  ...
  predictions_crop <- predict(object=rf_crop, newdata = validation_data_crop)
